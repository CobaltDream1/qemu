...
typedef enum VhostUserRequest {
    ...
    VHOST_USER_CRYPTO_FREEZE      = 50,
    VHOST_USER_CRYPTO_SAVE_STATE  = 51,
    VHOST_USER_CRYPTO_LOAD_STATE  = 52,
    VHOST_USER_CRYPTO_THAW        = 53,
    VHOST_USER_MAX
} VhostUserRequest;
...
#define VHOST_CRYPTO_ASYM_MAX_KEY_LEN  4096
